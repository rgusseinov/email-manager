          ...
          <div className="main__field-row">
            <div className="main__field-group single">
              <textarea className="main__field-group-single" placeholder="Сообщение">
                Проекция угловых скоростей, например, поступательно заставляет иначе взглянуть на
                то, что такое момент силы трения. Движение спутника вращает волчок. Начальное
                условие движения велико.
              </textarea>
              <div className="main__message-info"> </div>
            </div>
          </div>
